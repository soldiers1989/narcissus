package com.ih2ome.hardware_service.service.ammeterInterface.powerBee.util;
...
public class PowerBeeAmmeterUtil {
    ...
    public static String generateSign(String url,String randomNum,Long timestamp){
        return ConstUtils.md5(url+"timestamp="+timestamp+"&random="+randomNum+SECRET);
    }
    ...
    public static String generateParam(String uri){
        String randomNum = ConstUtils.getUUID();
