...
//	public static String trim(String orgStr, String removeStr, StringPositionEnum stringPositionEnum) {
//		if (isEmpty(orgStr) || isEmpty(removeStr) || stringPositionEnum.getCode() == StringPositionEnum.NONE.getCode()) {
//			return orgStr;
//		}
//		String newStr = orgStr;
//		if (stringPositionEnum.getCode() == StringPositionEnum.BEGIN.getCode() || stringPositionEnum.getCode() == StringPositionEnum.BOTH.getCode()) {
//			newStr = removeStart(newStr, removeStr);
//		}
//		if (stringPositionEnum.getCode() == StringPositionEnum.END.getCode() || stringPositionEnum.getCode() == StringPositionEnum.BOTH.getCode()) {
//			newStr = removeEnd(newStr, removeStr);
//		}
//		return newStr;
//	}
	 ...
	 * @return
	 */
	public static String stringfilter(String str, String[] filters) {
		String returnStr = str;
		for (String filter : filters) {
			if (returnStr.startsWith(filter) && returnStr.endsWith(filter)) {
				returnStr = returnStr.substring(0, returnStr.length() - filter.length());
				returnStr = returnStr.substring(filter.length());
				return returnStr;
			}
	...
	// String str = "asd12345678asd";
	// String[] filters = new String[]{"asd"};
	// System.out.println(StringUtils.stringfilter(str, filters));
	// }
