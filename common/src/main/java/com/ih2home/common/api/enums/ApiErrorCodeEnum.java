package com.ih2home.common.api.enums;
...
public enum ApiErrorCodeEnum {
    ...
    public ApiReturnValueVO toApiReturnValueVO() {
        return toApiReturnValueVO(null);
    }
    public ApiReturnValueVO toApiReturnValueVO(ApiReturnValueVO apiReturnValueVO) {
        if (apiReturnValueVO == null) {
            apiReturnValueVO = new ApiReturnValueVO();
        }
        apiReturnValueVO.setErrorEnum(this);
